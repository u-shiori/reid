...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--train',
        type=str,
        default="../data/MOT20-03_f100_shuffleTrue_skipframe1/train.txt",
        help='学習データのパス',
    )
    parser.add_argument(
        '--valid',
        type=str,
        default="../data/MOT20-03_f100_shuffleTrue_skipframe1/test.txt",
        help='検証データのパス',
    )
    parser.add_argument(
        '--test',
    ...
    main(args.model, args.train, args.valid, args.test)
