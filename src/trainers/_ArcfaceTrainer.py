...
class ArcfaceTrainer:
    def __init__(self, train_loader, valid_loader, test_loader, model, margin_penalty, train_loss_fn, test_loss_fn, sim_fn, device):
    ...
    def fit(self, lr, n_epochs, log_interval, save_epoch_interval, start_epoch=0, outdir="../result/checkpoint/", data_dirname=None):
        ...
        optimizer = optim.Adam([{'params': self.model.parameters()}, {'params': self.margin_penalty.parameters()}], lr=lr)
